...
export function Card({ title, content, icon, url }: CardProps) {
  return (
    <a
      href={url}
      className="flex items-stretch gap-6 overflow-hidden rounded bg-ignite-gray-3 transition-colors hover:bg-ignite-gray-7"
    >
      <div className="flex items-center bg-ignite-green-dark p-6">{icon}</div>
      ...
      <div className="flex items-center p-6 text-ignite-blue">
