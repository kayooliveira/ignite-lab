...
export type ChallengeCreateInput = {
  cl4py6kuy2kf801xsh84m9y5v?: InputMaybe<LessonCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
  url: Scalars['String'];
};
...
export type ChallengeUpdateInput = {
  cl4py6kuy2kf801xsh84m9y5v?: InputMaybe<LessonUpdateManyInlineInput>;
  url?: InputMaybe<Scalars['String']>;
};
...
export type LessonManyWhereInput = {
  ...
  /** All values that are contained in given list. */
  lessonType_in?: InputMaybe<Array<LessonTypes>>;
  /** All values that are not equal to given value. */
  lessonType_not?: InputMaybe<LessonTypes>;
  /** All values that are not contained in given list. */
  lessonType_not_in?: InputMaybe<Array<LessonTypes>>;
  publishedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  publishedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', id: string, slug?: string | null, title: string, videoId: string, description: string, availableAt?: any | null, teacher?: { __typename?: 'Teacher', avatarUrl: string, bio?: string | null, name: string } | null } | null };

export type GetLessonsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonTypes, slug?: string | null, title: string, availableAt?: any | null }> };
